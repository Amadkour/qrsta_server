...
public interface StudentCourseRepository extends JpaRepository<StudentCourse, Long> {
    List<StudentCourse> findByStudent_user_idAndActiveTrue(Long userId);

    List<StudentCourse> findAllByCourse_teacher_idAndFinishedFalse(Long teacherId);

    // double
    // getCourseCostByCourse_teacher_idAndFinishedFalseAndCoursePaymentLate(Long
    // teacherId, int late);
    ...
    public List<StudentCourse> getStudentByCourse_teacher_idAndCoursePaymentLate(Long teacherId, int late);

    public List<StudentCourse> getStudentByCourse_teacher_idAndCoursePaymentLateGreaterThan(Long teacherId, int late);
